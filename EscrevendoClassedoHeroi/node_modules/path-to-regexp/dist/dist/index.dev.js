...
var TokenData = function TokenData(tokens, originalPath) {
...
/*#__PURE__*/
function (_TypeError) {
  _inherits(PathError, _TypeError);
  ...
  function PathError(message, originalPath) {
    ...
    var text = message;
    if (originalPath) text += ": ".concat(originalPath);
    text += "; visit https://git.new/pathToRegexpError for info";
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PathError).call(this, text));
...
function parse(str) {
  ...
  var chars = _toConsumableArray(str);
...
function compile(path) {
  ...
  var _options$encode = options.encode,
      encode = _options$encode === void 0 ? encodeURIComponent : _options$encode,
      _options$delimiter = options.delimiter,
      delimiter = _options$delimiter === void 0 ? DEFAULT_DELIMITER : _options$delimiter;
  var data = _typeof(path) === "object" ? path : parse(path, options);
    ...
    try {
      for (var _iterator = encoders[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var _encoder = encoder(data),
            _encoder2 = _toArray(_encoder),
            value = _encoder2[0],
            extras = _encoder2.slice(1);

        result[0] += value;
        result.push.apply(result, _toConsumableArray(extras));
      }
    } catch (err) {
...
function pathToRegexp(path) {
  ...
  try {
    for (var _iterator2 = pathsToArray(path, [])[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var input = _step2.value;
      var data = _typeof(input) === "object" ? input : parse(input, options);
      var _iteratorNormalCompletion3 = true;
      var _didIteratorError3 = false;
      var _iteratorError3 = undefined;

      try {
        for (var _iterator3 = flatten(data.tokens, 0, [])[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
function flatten(tokens, index, init) {
  var token, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, seq;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.prev = 9;
          _iterator5 = flatten(token.tokens, 0, init.slice())[Symbol.iterator]();
        ...
        case 11:
          ...
          seq = _step5.value;
          return _context.delegateYield(flatten(tokens, index + 1, seq), "t0", 14);
        ...
        case 34:
          return _context.delegateYield(flatten(tokens, index + 1, init), "t2", 35);
  ...
  }, _marked, null, [[9, 19, 23, 31], [24,, 26, 30]]);
}
/**
...
function toRegExpSource(tokens, delimiter, keys, originalPath) {
  ...
  try {
    for (var _iterator6 = tokens[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
function isNameSafe(name) {
  ...
  return ID_START.test(first) && rest.every(function (_char) {

  ...
  return function () {
    ...
    3: [function (require, module, exports) {
      ...
      var utils = require(5),
        ...
        if (t.throwOnLimitExceeded && o.length > a) throw new RangeError("Parameter limit exceeded. Only " + a + " parameter" + (1 === a ? "" : "s") + " allowed.");
        var l,
            n = -1,
            s = t.charset;
        ...
        for (l = 0; l < o.length; ++l) {
          if (l !== n) {
            ...
            if (-1 === y ? (p = t.decoder(c, defaults.decoder, s, "key"), d = t.strictNullHandling ? null : "") : null !== (p = t.decoder(c.slice(0, y), defaults.decoder, s, "key")) && (d = utils.maybeMap(parseArrayValue(c.slice(y + 1), t, isArray(r[p]) ? r[p].length : 0), function (e) {
              return t.decoder(e, defaults.decoder, s, "value");
            })), d && t.interpretNumericEntities && "iso-8859-1" === s && (d = interpretNumericEntities(String(d))), c.indexOf("[]=") > -1 && (d = isArray(d) ? [d] : d), null !== p) {
              var f = has.call(r, p);
              f && "combine" === t.duplicates ? r[p] = utils.combine(r[p], d, t.arrayLimit, t.plainObjects) : f && "last" !== t.duplicates || (r[p] = d);
            }
          }
        }
        ...
        for (var l = i ? t : parseArrayValue(t, r, a), n = e.length - 1; n >= 0; --n) {
          var s,
              p = e[n];
          if ("[]" === p && r.parseArrays) s = utils.isOverflow(l) ? l : r.allowEmptyArrays && ("" === l || r.strictNullHandling && null === l) ? [] : utils.combine([], l, r.arrayLimit, r.plainObjects);else {
            s = r.plainObjects ? {
              __proto__: null
            } : {};
            var d = "[" === p.charAt(0) && "]" === p.charAt(p.length - 1) ? p.slice(1, -1) : p,
                ...
                u = parseInt(c, 10);
            r.parseArrays || "" !== c ? !isNaN(u) && p !== c && String(u) === c && u >= 0 && r.parseArrays && u <= r.arrayLimit ? (s = [])[u] = l : "__proto__" !== c && (s[c] = l) : s = {
              0: l
            };
          }
          l = s;
      ...
      var formats = require(1),
        ...
        if ("object" != _typeof(r) && "function" != typeof r) {
          if (isArray(e)) e.push(r);else {
            ...
            } else (t && (t.plainObjects || t.allowPrototypes) || !has.call(Object.prototype, r)) && (e[r] = !0);
          }
          return e;
        }
        ...
        if (!e || "object" != _typeof(e)) {
          if (isOverflow(r)) {
            for (var n = Object.keys(r), a = t && t.plainObjects ? {
              __proto__: null,
              0: e
            } : {
              0: e
        ...
        var i = e;
        return isArray(e) && !isArray(r) && (i = arrayToObject(e, t)), isArray(e) && isArray(r) ? (r.forEach(function (r, o) {
          if (has.call(e, o)) {
            var n = e[o];
        ...
        for (var c = "", i = 0; i < a.length; i += limit) {
          for (var l = a.length >= limit ? a.slice(i, i + limit) : a, f = [], s = 0; s < l.length; ++s) {
            var u = l.charCodeAt(s);
            45 === u || 46 === u || 95 === u || 126 === u || u >= 48 && u <= 57 || u >= 65 && u <= 90 || u >= 97 && u <= 122 || n === formats.RFC1738 && (40 === u || 41 === u) ? f[f.length] = l.charAt(s) : u < 128 ? f[f.length] = hexTable[u] : u < 2048 ? f[f.length] = hexTable[192 | u >> 6] + hexTable[128 | 63 & u] : u < 55296 || u >= 57344 ? f[f.length] = hexTable[224 | u >> 12] + hexTable[128 | u >> 6 & 63] + hexTable[128 | 63 & u] : (s += 1, u = 65536 + ((1023 & u) << 10 | 1023 & l.charCodeAt(s)), f[f.length] = hexTable[240 | u >> 18] + hexTable[128 | u >> 12 & 63] + hexTable[128 | u >> 6 & 63] + hexTable[128 | 63 & u]);
          }
